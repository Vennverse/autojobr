    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Automate your job applications with intelligent filters and one-click apply functionality. 
          Save hours of repetitive work and focus on what matters most.
        </p>
      </div>
      ...
      {!isExtensionInstalled ? (
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-green-900">Extension Installed Successfully!</h3>
              <p className="text-green-700">You can now configure your auto-apply settings below.</p>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            'Monster', 'ZipRecruiter', 'Dice', 'CareerBuilder'
          ].map((platform) => (
